(defproject identic "0.1.0-SNAPSHOT"
  :description "Duplicate file checker"
  :url "https://github.com/torresmi/identic.git"
  :license {:name "MIT Public License"
            :url "https://opensource.org/licenses/MIT"}
  :dependencies [[org.clojure/clojure "1.8.0"]
                 [org.clojure/clojurescript "1.9.14" :exclusions [org.apache.ant/ant]]
  ...
  :cljsbuild {:builds {:dev-main {:source-paths ["src"]
                                  ...
                                  :compiler {:output-to "app/dev/js/cljsbuild-main.js"
                                             ...
                                             :pretty-print true
                                             :output-wrapper true}}
                       :dev-front {:source-paths ["src_front" "src_front_profile/identic_front/dev"]
                                   :incremental true
                                   :jar true
                                   :assert true
                       ...
                       :prod-main {:source-paths ["src"]
                                   ...
                                   :compiler {:output-to "app/prod/js/cljsbuild-main.js"
                                              ...
                                              :pretty-print true
                                              :output-wrapper true}}
                       :prod-front {:source-paths ["src_front" "src_front_profile/identic_front/prod"]
                                    :incremental true
                                    :jar true
                                    :assert true
